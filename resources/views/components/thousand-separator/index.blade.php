@props(['name', 'id' => $name, 'value' => null])

<div class="w-full" x-data="thousandSeparator({{ $value ?? 'null' }})" x-init="init()">
...
@pushOnce('body')
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('thousandSeparator', (initialValue = null) => ({
                rawValue: null,
                ...
                updateValues(event) {
                    ...
                    this.rawValue = cleanValue === '' ? null : parseInt(cleanValue, 10);
