<x-select name="icon" :display-icon="true">
    <x-select.option value="like">
        <x-slot:icon>
        ...
        <x-slot:label>Like</x-slot:label>
    </x-select.option>
    <x-select.option value="heart">
        <x-slot:icon>
        ...
        <x-slot:label>Heart</x-slot:label>
    </x-select.option>
</x-select>
