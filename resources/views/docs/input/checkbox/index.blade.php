        ...
        <div class="flex flex-col gap-5">
            <x-card>
                <div class="p-6 flex flex-col gap-5">
                    ...
                    <pre class="text-[0.9rem]"><code class="language-">php artisan lazy:component checkbox</code></pre>
                </div>
            </x-card>

            <x-card>
                <div class="p-6 flex flex-col gap-5">
                    <div class="text-xl font-semibold">Variants</div>
                    <div x-data="{ tab: 'preview' }">
                        ...
                        <div>
                            <div x-show="tab === 'preview'">
                                <div class="rounded-xl px-3 py-6 bg-cat-200 dark:bg-cat-750">
                                    <div class="flex flex-wrap gap-3 justify-center">
                                        @include('docs.input.checkbox.default')
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/input/checkbox/default.blade.php');
                    ...
                    <div x-data="{ tab: 'preview' }">
                        ...
                        <div>
                            <div x-show="tab === 'preview'">
                                <div class="rounded-xl px-3 py-6 bg-cat-200 dark:bg-cat-750">
                                    <div class="flex flex-wrap gap-3 justify-center">
                                        @include('docs.input.checkbox.text')
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/input/checkbox/text.blade.php');
                                    $content = file_exists($file) ? file_get_contents($file) : 'File not found';
                                @endphp
                                <pre class="text-[0.9rem]"><code class="language-html">{{ $content }}</code></pre>
                            </div>
                    ...
                    <div x-data="{ tab: 'preview' }">
                        ...
                        <div>
                            <div x-show="tab === 'preview'">
                                <div class="rounded-xl px-3 py-6 bg-cat-200 dark:bg-cat-750">
                                    <div class="flex flex-wrap gap-3 justify-center">
                                        @include('docs.input.checkbox.custom')
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/input/checkbox/custom.blade.php');
                                    $content = file_exists($file) ? file_get_contents($file) : 'File not found';
                                @endphp
                                <pre class="text-[0.9rem]"><code class="language-html">{{ $content }}</code></pre>
                            </div>
