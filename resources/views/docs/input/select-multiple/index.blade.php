        ...
        <div class="flex flex-col gap-5">
            <x-card>
                <div class="p-6 flex flex-col gap-5">
                    <div>
                        <div class="text-xl font-semibold">Select Multiple</div>
                    ...
                    <div x-data="{ tab: 'preview' }">
                        ...
                        <div>
                            <div x-show="tab === 'preview'">
                                <div class="rounded-xl px-3 py-6 bg-cat-200 dark:bg-cat-750">
                                    <div class="flex flex-wrap gap-3 justify-center max-w-xs mx-auto">
                                        @include('docs.input.select-multiple.default')
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/input/select-multiple/default.blade.php');
