        ...
        <div class="flex flex-col gap-10">
            <section>
                <div class="mb-5">
                    ...
                    <div class="text-cat-500 text-sm">Example usage form component.</div>
                </div>
            </section>

            <section>
                <div class="mb-5">
                    <div class="text-xl font-semibold">Form Create (Frontend)</div>
                    <div class="text-cat-500 text-sm">This is an example form for a store (insert) action in Laravel.</div>
                </div>
                        ...
                        <div class="rounded-xl bg-white dark:bg-cat-800 border border-dashed border-cat-300 dark:border-cat-700">
                            <div x-show="tab === 'preview'">
                                <div class="flex flex-wrap gap-3 justify-center px-3 py-10 max-w-xs mx-auto">
                                    @include('docs.input.form-group.store')
                                </div>
                            </div>

                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/input/form-group/store.blade.php');
            ...
            <section>
                <div class="mb-5">
                    <div class="text-xl font-semibold">Form Create (Backend)</div>
                    <div class="text-cat-500 text-sm">Example implementation of a store action in the backend</div>
                </div>
                @php
                    $file = resource_path('views/docs/input/form-group/store-backend.blade.php');
                    $content = file_exists($file) ? file_get_contents($file) : 'File not found';
                @endphp
            ...
            <section>
                <div class="mb-5">
                    <div class="text-xl font-semibold">Form Edit (Frontend)</div>
                    <div class="text-cat-500 text-sm">This is an example form for a edit (update) action in Laravel.</div>
                </div>
                ...
                <div x-data="{ tab: 'preview' }">
                    ...
                    <div>
                        <div class="rounded-xl bg-white dark:bg-cat-800 border border-dashed border-cat-300 dark:border-cat-700">
                            <div x-show="tab === 'preview'">
                                <div class="flex flex-wrap gap-3 justify-center px-3 py-10 max-w-xs mx-auto">
                                    @include('docs.input.form-group.update')
                                </div>
                            </div>

                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/input/form-group/update-code.blade.php');
                                    $content = file_exists($file) ? file_get_contents($file) : 'File not found';
                                @endphp
                                <pre class="text-[0.9rem] p-0"><code class="language-html">{{ $content }}</code></pre>
                            </div>
            ...
            <section>
                <div class="mb-5">
                    <div class="text-xl font-semibold">Form Edit (Backend)</div>
                    <div class="text-cat-500 text-sm">Example implementation of a edit (update) action in the backend</div>
                </div>
                @php
                    $file = resource_path('views/docs/input/form-group/update-backend.blade.php');
                    $content = file_exists($file) ? file_get_contents($file) : 'File not found';
                @endphp
                <pre class="text-[0.9rem] p-0"><code class="language-php">{{ $content }}</code></pre>
            </section>
