...
@section('content')
    <div class="lazy-container-sm">
        ...
        <div class="flex flex-col gap-10">
            <section>
                <div class="mb-5">
                    <div class="text-3xl font-bold">Widget</div>
                    <div class="text-cat-500 text-sm">A widget is a small component that can be used to display information.</div>
                </div>
            </section>
                        ...
                        <div class="rounded-xl bg-white dark:bg-cat-800 border border-dashed border-cat-300 dark:border-cat-700">
                            <div x-show="tab === 'preview'">
                                <div class="p-3 mx-auto">
                                    @include('docs.display.widget.analytics')
                                </div>
                            </div>

                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/display/widget/analytics.blade.php');
