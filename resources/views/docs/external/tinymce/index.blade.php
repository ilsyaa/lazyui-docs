...
@section('content')
    <div class="lazy-container-sm">
        ...
        <div class="flex flex-col gap-10">
            <section>
                <div class="mb-5">
                    <div class="text-3xl font-bold">TinyMCE</div>
                    <div class="text-cat-500 text-sm">The Most Trusted and Feature-rich WYSIWYG Rich Text Editor.</div>
                </div>
                <div>
                    ...
                    <div class="rounded-xl bg-white dark:bg-cat-800 border border-dashed border-cat-300 dark:border-cat-700">
                        <pre class="text-[0.9rem]"><code class="language-">php artisan lazy:component tinymce</code></pre>
                    </div>
                </div>
            </section>
                    ...
                    <div>
                        <div class="rounded-xl bg-white dark:bg-cat-800 border border-dashed border-cat-300 dark:border-cat-700">
                            <div x-show="tab === 'preview'">
                                <div class="p-3">
                                    @include('docs.external.tinymce.basic')
                                </div>
                            </div>

                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/external/tinymce/basic.blade.php');
            ...
            <section>
                <div class="mb-5">
                    <div class="text-xl font-semibold">AI</div>
                    <div class="text-cat-500 text-sm">Add a route with the name ai like this in the route.</div>
                </div>
                @php
                    $file = resource_path('views/docs/external/tinymce/ai.blade.php');
                    $content = file_exists($file) ? file_get_contents($file) : 'File not found';
                @endphp
