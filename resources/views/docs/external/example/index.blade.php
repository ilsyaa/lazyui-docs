        ...
        <div class="flex flex-col gap-10">
            <section>
                <div class="mb-5">
                    ...
                    <div class="text-cat-500 text-sm">An image element with a fallback for representing the user.</div>
                </div>
                <div>
                    ...
                    <div class="rounded-xl bg-white dark:bg-cat-800 border border-dashed border-cat-300 dark:border-cat-700">
                        <pre class="text-[0.9rem]"><code class="language-">php artisan lazy:plugin apexcharts</code></pre>
                    </div>
                </div>
            </section>
                        ...
                        <div class="rounded-xl bg-white dark:bg-cat-800 border border-dashed border-cat-300 dark:border-cat-700">
                            <div x-show="tab === 'preview'">
                                <div class="flex flex-wrap gap-3 justify-center px-3 py-10 max-w-lg mx-auto">
                                    @include('docs.external.apexcharts.basic')
                                </div>
                            </div>

                            <div x-show="tab === 'code'" x-cloak>
                                @php
                                    $file = resource_path('views/docs/external/apexcharts/basic.blade.php');
