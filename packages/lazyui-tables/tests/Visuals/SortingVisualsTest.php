    ...
    public function test_th_headers_are_buttons_with_sorting_enabled(): void
    {
        Livewire::test(PetsTable::class)
            ->assertSeeHtmlInOrder([
                ...
                'class="text-cat-500 dark:text-cat-400 flex items-center space-x-1 text-left text-xs leading-4 font-medium uppercase tracking-wider group focus:outline-none"',
            ]);
    }
    ...
    public function test_th_headers_are_not_buttons_with_sorting_disabled(): void
    {
        Livewire::test(PetsTable::class)
            ...
            ->assertDontSeeHtml('<button
                wire:click="sortBy(\'id\')"
                class="flex items-center space-x-1 text-left text-xs leading-4 font-medium uppercase tracking-wider group focus:outline-none text-cat-500 dark:text-cat-400"
            >');
    ...
    public function test_th_headers_are_not_buttons_unless_the_column_is_sortable(): void
    {
        Livewire::test(PetsTable::class)
            ->assertDontSeeHtml('<button
                ...
                class="flex items-center space-x-1 text-left text-xs leading-4 font-medium text-cat-500 uppercase tracking-wider group focus:outline-none dark:text-cat-400"
            >');
    }
