        ...
        <select multiple
            {!! $filter->getWireMethod('filterComponents.'.$filter->getKey()) !!} {{
                ...
                ->class([
                    ...
                    'border-cat-300 focus:border-indigo-300 focus:ring-indigo-200 dark:bg-cat-800 dark:text-white dark:border-cat-600' => $isTailwind && ($filterInputAttributes['default-colors'] ?? true),
